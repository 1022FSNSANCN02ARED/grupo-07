...
--
-- Host: localhost    Database: argondb
-- ------------------------------------------------------
...
CREATE TABLE `carrito` (
  ...
  CONSTRAINT `carrito_ibfk_2` FOREIGN KEY (`usuarioId`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `carrito_ibfk_3` FOREIGN KEY (`productosId`) REFERENCES `productos` (`id`)
...
CREATE TABLE `productos` (
  ...
  `gamaId` int(1) DEFAULT NULL,
  `rolId` int(1) DEFAULT NULL,
  `imagen` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `marcaId` (`marcaId`),
  KEY `gamaId` (`gamaId`),
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`marcaId`) REFERENCES `marca` (`id`),
  CONSTRAINT `productos_ibfk_2` FOREIGN KEY (`gamaId`) REFERENCES `gama` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-21 20:29:26
